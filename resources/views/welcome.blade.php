...
<link rel="stylesheet" type="text/css" href=""{{ assets ('css/facultystyle.css')}}" />
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="welcome.blade.php">Career Builder</a>
        </div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-sm-4 ggrids">
							<a href="{{ assets ('images/big7.jpg')}}" title="This is the description">
							<img src="images/7.jpg">
								<div class="description">
									<span class="caption">Science Lab</span> 
						...
						<div class="col-md-4 col-sm-4 ggrids">
							<a href="{{ assets ('images/big4.jpg')}}" title="This is the description">
							<img src="images/4.jpg">
								<div class="description">
									<span class="caption">Indoor Stadium</span> 
									<span class="camera"></span>
									<div class="clearfix"></div>
								</div>
							</a>
						...
						<div class="col-md-4 col-sm-4 ggrids">
							<a href="{{ assets ('images/big2.jpg')}}" title="This is the description">
							<img src="images/2.jpg">
								<div class="description">
									<span class="caption">Transportation</span> 
									<span class="camera"></span>
									<div class="clearfix"></div>
								</div>
							</a>
						...
						<div class="col-md-4 col-sm-4 ggrids">
							<a href="{{ assets ('images/big3.jpg')}}" title="This is the description">
							<img src="images/3.jpg">
								<div class="description">
									<span class="caption">Kids Room</span> 
									<span class="camera"></span>
									<div class="clearfix"></div>
								</div>
							</a>
						...
						<div class="col-md-4 col-sm-4 ggrids">
							<a href="images/big5.jpg" title="This is the description">
							<img src="images/5.jpg">
								<div class="description">
									<span class="caption">Meditation Classes</span> 
									<span class="camera"></span>
									<div class="clearfix"></div>
								</div>
							</a>
						...
						<div class="col-md-4 col-sm-4 ggrids">
							<a href="images/big19.jpg" title="This is the description">
							<img src="images/19.jpg">
								<div class="description">
									<span class="caption">Kids Play Ground</span> 
									<span class="camera"></span>
									<div class="clearfix"></div>
								</div>
							</a>
	...
	<div class="container">
		...
		<div class="cbottom">
			<div class="col-md-6 col-sm-6 cbl">
				...
				<h4>Our Website:</h4>
				<h5><a href="https://w3layouts.com/">www.w3layouts.com</a></h5>
            </div>
